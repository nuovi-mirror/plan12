...
<html lang=en>
	<head> 
		<title>Plan 12 - A Post-UNIX Research Operating System Architecture</title>
		<meta name="description" content="Plan 12 is a research operating system architecture exploring a post-UNIX design with decentralized processes and file-based system interfaces.">
	...
	<body>
		<div class="sidebar" >
				<img src="data/logo.jpg" alt="The Plan 12 OS logo" style="width:185px;height:185px;">
				<h3>The Plan 12 website</h3>
				<ul>
					<link rel="canonical" href="http://plan12os.org/">
					<li><a href="/">Home</a></li>
  					<li><a href="data/">Download</a></li>
  					<li><a href="contact.html">Contact</a></li>
					<li><a href="data/license.txt">License</a></li>
					<li><a href="status.html">Status</a></li>
				</ul>
		</div>

		<div class="content">
				<h1><i>Plan 12</i></h1> <h3>- A Post-UNIX Operating System Architecture</h3>
				<h4><i>"UNIX? Never heard of it."</i></h4>
			...
			<p>
				...
				through a unified file interface.
			</p>

				<h4>Plan 12 is not a microkernel or exokernel</h4>
			<p>
			...
			<p>
				More projects made by me can be found on my <a href="https://codeberg.org/vantheman/">Codeberg profile</a>
